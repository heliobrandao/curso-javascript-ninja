...
function adicionaPessoa(qdt){
  var totalDePessoas = carro.quantidadedePessoas +qtd;
  var sobra = carro.assentos - carro.quantidadedePessoas;
...
carro.obterMarcaModelo() //Esse carro é um Chevrolet Chevette
